...
class MongodbNotFoundControllerTest extends TestAsserter
{
    ...
    public function addDataProvider()
    {
        ...
        [
            ...
            ["kind"=>"unit", "test"=>['method'=>'POST'  , 'url'=>'/api/entity/00300000-0000-4000-a000-000000000001/file/photo'  , "status"=>404, 'token'=>'token_userActive']],
            ["kind"=>"unit", "test"=>['method'=>'POST'  , 'url'=>'/api/entity/00300000-0000-4000-a000-000000000000/file/invalid', "status"=>404, 'token'=>'token_userActive']],

            ["kind"=>"unit", "test"=>['method'=>'GET'   , 'url'=>'/api/entity/00300000-0000-4000-a000-000000000001/file/photo'  , "status"=>404, 'token'=>'token_userActive']],
            ["kind"=>"unit", "test"=>['method'=>'GET'   , 'url'=>'/api/entity/00300000-0000-4000-a000-000000000000/file/invalid', "status"=>404, 'token'=>'token_userActive']],

            ["kind"=>"unit", "test"=>['method'=>'DELETE', 'url'=>'/api/entity/00300000-0000-4000-a000-000000000001/file/photo'  , "status"=>404, 'token'=>'token_userActive']],
            ["kind"=>"unit", "test"=>['method'=>'DELETE', 'url'=>'/api/entity/00300000-0000-4000-a000-000000000000/file/invalid', "status"=>404, 'token'=>'token_userActive']],
